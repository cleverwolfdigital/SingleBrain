...
BUSINESSES = [
    ...
    ("Kimchee #88", "K8", 2, "—", "Planning", "warning", "business", None),
...
PROJECTS = [
    ...
    ("Kimchee #88 Restaurant Launch", "Kimchee #88", "Planning", "warning", "active", "Legal setup + brand development", "Feb/Apr 2027", "project"),
